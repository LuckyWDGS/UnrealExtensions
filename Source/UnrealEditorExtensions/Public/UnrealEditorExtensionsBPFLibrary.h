...
public: 
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Path")
		static UObject* GetOpenObjecFromToolMenuContext(const FToolMenuContext& InContext);

	//获取内容浏览器选中的文件夹
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|ContentBrowser")
		static TArray<FString> GetSelectedFolders();

	//获取所有的工具菜单栏
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Tool Menus")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|ActorFactory", meta = (WorldContext = "WorldContextObject"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|ViewPort", meta = (WorldContext = "WorldContextObject"))
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|BluePrint")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|Thumbnail")
		static UTexture2D*  GetObjectThumbnail(const FAssetData& AssetData);

	/* 获取类的所有属性
	 * @param	Class				类。
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Properties")
...
/*************************************************资产操作*************************************************************/
	 ...
	 * @param	Asset					需要定位的资产。
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Asset")
	 ...
	 * @param	AssetData				资产数据
	 */
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|Asset")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Setting", meta = (WorldContext = "WorldContextObject"))
...
/******************************************************************编辑器工具类函数*******************************************************/
	/*关闭所有区域
	 */
	UFUNCTION(BlueprintCallable, Category = "EditorExtensions|Editor")
	 ...
	 */
	UFUNCTION(BlueprintPure, Category = "EditorExtensions|Editor")
